...
MetricChat is a platform that allows users to leverage LLM agents to query and analyze data from third-party data sources, including databases, services, and files. 
...
4. [Installation](/documents/installation.md): Deploying MetricChat SaaS
